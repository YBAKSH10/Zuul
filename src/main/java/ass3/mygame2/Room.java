 ...
 * Room class has its neighbors 
 * Room class also has an option from where a player can leave
 * Moreover, there is a direction as well that is to be followed (North, South, East, West - depending upon the needs and requirements) 
 * @author  Yamini Bakhsi abd Umer Jahangir
 * @version 22.09.2021
 */
...
public class Room 
{
     ...
     * Here comes the brief explanation of the room
     */
